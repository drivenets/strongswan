...
typedef struct private_kernel_libipsec_cheetah_router_t private_kernel_libipsec_cheetah_router_t;
 ...
 */
kernel_libipsec_cheetah_router_t *router;

/**
 * Private data
 */
struct private_kernel_libipsec_cheetah_router_t {

	/**
	 * Public interface
	 */
	kernel_libipsec_cheetah_router_t public;
 ...
 * Inbound callback
 */
static void deliver_plain(private_kernel_libipsec_cheetah_router_t *this,
						  ip_packet_t *packet)
{
	tun_device_t *tun;
 ...
 */
static job_requeue_t handle_plain(private_kernel_libipsec_cheetah_router_t *this)
{
...
METHOD(kernel_listener_t, tun, bool,
	private_kernel_libipsec_cheetah_router_t *this, tun_device_t *tun, bool created)
{
	tun_entry_t *entry, lookup;
	char buf[] = {0x01};
...
METHOD(kernel_libipsec_cheetah_router_t, get_tun_name, char*,
	private_kernel_libipsec_cheetah_router_t *this, host_t *vip)
{
	tun_entry_t *entry, lookup = {
		.addr = vip,
	};
...
METHOD(kernel_libipsec_cheetah_router_t, destroy, void,
	private_kernel_libipsec_cheetah_router_t *this)
{
 ...
 * See header file
 */
kernel_libipsec_cheetah_router_t *kernel_libipsec_cheetah_router_create()
{
	private_kernel_libipsec_cheetah_router_t *this;
