...
#ifndef KERNEL_LIBIPSEC_CHEETAH_IPSEC_H_
#define KERNEL_LIBIPSEC_CHEETAH_IPSEC_H_

#include <library.h>
#include <kernel/kernel_ipsec.h>

typedef struct kernel_libipsec_cheetah_ipsec_t kernel_libipsec_cheetah_ipsec_t;

/**
 * Implementation of the ipsec interface using libipsec
 */
struct kernel_libipsec_cheetah_ipsec_t {
...
#endif /** KERNEL_LIBIPSEC_CHEETAH_IPSEC_H_ @}*/
